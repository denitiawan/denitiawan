...
iam currently working as `Backend & System Analyst` at tech company Service. and for completally my software development skills, i am also learning `frontend` `architect` `devops` and `software documentation`.
